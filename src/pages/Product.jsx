      ...
      <div>
        ...
        <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row '>
          ...
          <div className='flex-1'>
            ...
            <p className='mt-5 text-3xl font-mediam'> {currency}{productData.price} </p>
            <div
  className="mt-5 text-gray-500 md:w-4/5 leading-7"
...
></div>
        ...
        <div className='mt-20'>
          <div className='flex'>
            ...
            <p className='border px-5 py-3 textt-sm'>Reviews (122)</p>
          </div>
